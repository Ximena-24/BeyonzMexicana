...
<body class="hold-transition sidebar-collapse">
    <div class="estilo py-4">
        ...
        <!-- Main content -->
        <form class="formulario" action="QueryCambio.php" method="post" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="col-8">
                            ...
                            <div class="card">
                                <div class="card-header container-fluid">
                                    ...
                                    <div class="row">
                                        <h5 style="color: #001571;"><i class='fa fa-edit'></i> Cambio de linea</h5>
                                    </div>
                                </div>
                                <div class="card-body">
