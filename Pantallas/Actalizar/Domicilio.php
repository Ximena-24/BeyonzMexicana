...
empleado.curp,empleado.nivel_organigrama,PuntosAbordaje.Nombre_punto,PuntosAbordaje.Numero_ruta
FROM empleado FULL JOIN SM_AltaFinanzas ON empleado.id_usuario = SM_AltaFinanzas.AF_NN
INNER JOIN PersonalTransporte ON empleado.id_usuario = PersonalTransporte.ID
INNER JOIN PuntosAbordaje ON PersonalTransporte.Id_punto = PuntosAbordaje.Id_punto
WHERE empleado.estatus = 1 AND empleado.id_usuario = $id_usuario";

$query_img = "SELECT * FROM [BEYONZ].[dbo].[Fotos] WHERE Fotos_NN = $id_usuario";
...
while ($fila = sqlsrv_fetch_array($result)) {
    ...
    $curp = $fila['curp'];
    $nivel_organigrama = $fila['nivel_organigrama'];
...
<body class="hold-transition sidebar-collapse">
    ...
    <div class="estilo py-3">
        <div class="container">
            ...
            <!-- Main content -->
            <form class="formulario" action="Updomicilio.php" method="post" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-header container-fluid">
                                    <div class="row">
                                        <h4 style="color: #00043D;"><img src="../../img/dom.webp" alt="" width="75" height="60">
                                            Actualizar Información de Domicilio</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <table>
                                        <td><img src="http://mx-server08:8080/Personal/<?php echo $img ?>.jpg" alt="" class="img-thumbnail" width="600"></td>
                                        <td style="padding: 2%;">
                                            <div class="row">
                                                <div class="col-md-1">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>CURP</label>
                                                        <input type="text" class="form-control" id="curp" name="curp" value="<?php echo $curp ?>" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="Nombre_punto" name="Nombre_punto" value="<?php echo $Nombre_punto ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-1">
                                                    <div class="form-group">
                                                        <label>Ruta</label>
                                                        <input type="text" class="form-control" id="Numero_ruta" name="Numero_ruta" value="<?php echo $Numero_ruta ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-1">
                                                    <div class="form-group">
                                                        <label>Quincenal/Semanal</label>
                                                        <input type="text" class="form-control" id="nivel_organigrama" name="nivel_organigrama" value="<?php echo $nivel_organigrama ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-1"> </div>
                                                <div class="col-md-7">
                                                    <div class="form-group">
                                                        <label><strong>Nuevo Domicilio:</strong></label>
                                                        <input type="text" class="form-control" id="AF_Domicilio" name="AF_Domicilio" value="<?php echo $AF_Domicilio ?>">
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="card-footer text-center">
                                                    <button class="btn btn-primary" type="post">Actualizar Domicilio</button>
                                                </div>
                                            </div>
                                        </td>
                                    </table>
