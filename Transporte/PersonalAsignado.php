...
<body class="hold-transition sidebar-collapse">
  ...
  <form class="formulario" action="PersonalAsignado.php" method="post" autocomplete="off" enctype="multipart/form-data">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header container-fluid">
                <div class="row">
                  <h4 style="color: #00043D; Font-family: Arial"><i class='fa fa-bus'></i> PERSONAL CON PUNTO DE ABORDAJE ASIGNADO</h4>
                </div>
              </div>
                ...
                <table id="myTable" class="table table-bordered table-striped display nowrap" style="width:100%">
                  <thead style="text-align: center;">
                    <tr>
                      ...
                      <th class="sorting text-center">Nombre Punto de Abordaje</th>
                      <th class="sorting text-center">Ruta</th>
                      <th class="sorting text-center">Editar Punto o Domicilio</th>
                    </tr>
                  </thead>
                  ...
                  <tbody style="text-align: center;">
                    ...
                    $query = "SELECT empleado.id_usuario,empleado.usuario,empleado.puesto,empleado.area,SM_AltaFinanzas.AF_Domicilio,
                      ...
                      WHERE empleado.estatus = 1 ORDER BY empleado.id_usuario asc";
                    ...
                    while ($fila = sqlsrv_fetch_array($result)) {
                      ...
                      echo "<td> 
            <a class='btn btn-dark' href='../Pantallas/Actalizar/actualizar.php?id_usuario=" . $fila['id_usuario'] . "' ><i class='fa fa-edit'></i> Punto</a>
            <a class='btn btn-info' href='../Pantallas/Actalizar/Domicilio.php?id_usuario=" . $fila['id_usuario'] . "' ><i class='fa fa-edit'></i> Domicilio</a> 
                        </td>";
                      echo "</tr>";
                    }
                    ?>
    ...
    $(document).ready(function() {
      $("#myTable").DataTable({
        ...
        buttons: [{
            ...
            extend: 'excel',
            footer: true,
            title: 'Personal con Puntos de Abordaje',
            filename: 'Personal con Puntos de Abordaje',
            //Aquí es donde generas el botón personalizado
            text: '<button class="btn btn-primary">Exportar a Excel <i class="fas fa-file-excel"></i></button>'
          }
        ]
      });
    });
