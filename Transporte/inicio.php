...
<body class="hold-transition sidebar-collapse">
    ...
    <div class="estilo py-3">
        <div class="container">
                ...
                <nav>
                    <ul>
                        <li>
                            ...
                            <a class="btn btn-danger" href="../logout.php" title="Log out"><i class="fa fa-share"></i> Cerrar Sesion</a></a>
                        </li>
                    </ul>
                </nav>
            </header>

            <div class="container py-2"><!-- Cambio de colores Inicio -->
                <div class="row">
                    <div class="col-10">
            ...
            </div><!-- Cambio de colores Fin -->
            <br>
            <div class="contaner"><!-- Contenedor imagen Bootstrap Inicio-->
                <div class="row">
                    <div class="col-1"></div>
            ...
            </div><!-- Contenedor imagen Bootstrap Fin-->
            ...
            <br>
            <div class="container py-3"><!-- Opciones de Administrador -->
                <div class="row">
                    <div class="col-sm-4">
                        <div class="card">
                            <div class="card-body text-center">
                                <img src="../img/2601879.png" alt="" width="70" height="70"></a>
                                <h4 style="color: #000F43;"><strong>VERIFICAR REPORTES | EXTRAER REPORTES</strong></h4>
                                <p class="card-text">Exportar Reportes de Transporte Solicitado</p>
                                <a href="../Transporte/Verificacion.php" class="btn btn-warning"><i class="fa fa-check" aria-hidden="true"></i> Verificar</a>
                                <a href="../Transporte/Ext_Reporte.php" class="btn btn-success"><i class="fa fa-file" aria-hidden="true"></i> Reportes</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="card">
                            <div class="card-body text-center">
                                <img src="../img/formulario.png" alt="" width="70" height="70"></a>
                                <h4 style="color: #000F43;"><strong>SOLICITAR TRANSPORTE</strong></h4>
                                <p class="card-text">Registrar Personal Para Transporte</p>
                                <a href="../Transporte/index.php" class="btn btn-primary"> <img src="../img/solicitud.png" alt="" width="25"> Solicitudes</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="card">
                            <div class="card-body text-center">
                                <img src="../img/1232880.png" alt="" width="75" height="75"></a>
                                <h4 style="color: #000F43;"><strong>TODO PERSONAL | PUNTOS | RUTAS</strong></h4>
                                <p class="card-text">Todo el Personal y Sus puntos de Abordaje</p>
                                <a href="../Transporte/botones.php" class="btn btn-primary"><img src="../img/people.png" alt="" width="25"> Ver Personal</a>
                            </div>
                        </div>
                    </div>
                    <br>
                </div>
            </div><!-- Opciones de Administrador -->
            <br><br>

            <!-- footer section start -->
            <div class="contai mt-3" style="font-family: monospace;">
                <div class="row">
                        ...
                        <section class="container-fluid text-white-50 py-5 px-sm-3 px-lg-5" style="background-color: rgba(213, 212, 212, 0.466)">
                            <div class="box">
                                ...
                                <div class="credit" style="color: rgb(1, 1, 94);">
                                    &copy; BEYONZ <span> MEXICANA. 2024 </span>
                                </div>
                            </div>
                        </section>
                        <!-- footer section End  -->
            ...
            <!-- Topbar Start -->
            <div class="container-fluid bg-light pt-3 d-none d-lg-block" style="color: #0a0a0b;">
                <div class="container">
                    <div class="row">
