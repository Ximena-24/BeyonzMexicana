...
<head>
    ...
    <title>Transporte Especial</title>
    <!-- Google Web Fonts -->
        ...
        <div class="container">
            ...
            <div class="container py-2">
                <div class="row">
                    ...
                    <div class="col-4 text-left py-1">
                        ...
                        echo "<h3 class='nav-link' style='color: #00135F;'><i class='nav-icon fa fa-users'></i>" . " " . $Usuario . "</h3>"; ?>
                    </div>
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-8 text-left">
                    <h1 class="form-label" style="color: #5F0014;"><em><strong>Transporte Especial (Sabado)</strong></em></h1>
                </div>
            </div>
        </div>

        <form class="formulario" autocomplete="off" action="Sabado.php" method="GET">
            <div class="card-body">
                <div class="container">
        ...
        <div class="container-fluid">
            <div class="card container bg-white rounded shadow">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <form id="formulario" method="POST" action="../registrar2.php">
                                <div class="card-body">
                                    <div class="row">
                                        <?php
                                        ...
                                        ?>
                                            ...
                                            <h3 class="w-100 text-center mb-4" style="font-family: Tahoma ; color:#BF0000;">COMPLETAR INFORMACION TRANSPORTE SABADO</h3>
                                            ...
                                            <div class="col-md-6 py-4">
                                                <div class="form-group text-center">
                                                    <h5 style="font-family: Arial; color:#01168E;"><strong>Selecciona Horario:</strong></h5>
                ...
                <div class="row">
                                    ...
                                    <div class="col-6 py-4">
                                        <div class="cf-cover">
                                            <div class="session-title">
                                                <h4><i class='fa fa-bus'></i> Solicitudes de Transporte Especial Realizadas por:
                                                    <?php $Usuario = $_SESSION['UserName'];
                            ...
                            <div class="card-body">
                                <table id="myTable" class="table table-bordered table-striped display nowrap" style="width:100%">
                                    <thead style="text-align: center;">
                                        <tr>
                                            <th class="sorting text-center" style="background-color: #40FFA2;">Nomina </th>
                    ...
                    and SolicitudTransporte.Responsable = '$Usuario'";
                                        ...
                                        while ($row = sqlsrv_fetch_array($result)) {
                                            echo "<tr>";
                                            echo "<td style='background-color: #A1F9CE; font-weight: bold;'>" . $row['ID'] . "</td>";
