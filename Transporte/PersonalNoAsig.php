...
<head>
  ...
  <title>Personal Sin Punto</title>
  <!-- Google Web Fonts -->
  ...
  <div class="contaner">
    <div class="row">
      ...
      <div class="col-3 text-center">
        <h1 class="m-0">
          <a class="btn btn-warning" href="NoTransporte.php"><img class="imagen" src="../img/trans.png" width="30" height="30"> Personal Que No UtilizaTransporte</a>
        </h1>
      </div>
    </div>
  </div><br>
-->
  <form class="formulario" action="PersonalNoAsig.php" method="post" autocomplete="off" enctype="multipart/form-data">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header container-fluid">
                <div class="row">   
                  <h4 style="color:red; Font-family: Verdana ;"><img src="../img/ng.jpg" alt="" width="50" height="50">
                  PERSONAL PUNTOS NO ASIGNADOS</h4>
                </div>
              </div>
              <div class="card-body">
                <table id="myTable" class="table table-bordered table-striped display nowrap" style="width:100%">
                  ...
                  <tbody style="text-align: center;">
                    ...
                    $query = "SELECT empleado.id_usuario,empleado.usuario,empleado.puesto,empleado.area,SM_AltaFinanzas.AF_Domicilio,
                      ...
                      WHERE empleado.estatus = 1 and PersonalTransporte.Id_punto = 0 ORDER BY empleado.id_usuario asc";
                    ...
                    while ($fila = sqlsrv_fetch_array($result)) {
                      ...
                      echo "<td> 
                        <a class='btn btn-success' href='../Agregar/Agregar.php?NN=" . $fila['id_usuario'] . "' ><i class='fa fa-edit'></i>Agregar</a>
                         </td>";
                      echo "</tr>";
                    }
                    ?>
    ...
    $(document).ready(function() {
      $("#myTable").DataTable({
        ...
        buttons: [{
            ...
            extend: 'excel',
            footer: true,
            title: 'PUNTOS NO ASIGNADOS',
            filename: 'PUNTOS NO ASIGNADOS',
