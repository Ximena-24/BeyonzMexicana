...
<body class="hold-transition sidebar-collapse">
    <div class="estilo py-4">
        <div class="container">
            <header style="background-color: rgb(21, 21, 192);">
                ...
                <nav>
                    <ul>
                        <li>
                            <a class="btn btn-dark" href="PreListado2.0.php" title=""><i class="fa fa-home"></i> Inicio</a></a>
        ...
        <form class="formulario" action="MiPersonal.php" method="post" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-9 text-left py-1">
                                            <div class="cf-cover">
                                                <div class="session-title">
                                                    <h2 class="form-label" style="color: #002336;"><em><strong><i class='fa fa-users'></i> SECCION DE PERSONAL</strong></em></h2>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-3 text-lg-right py-1">
                                            <div class="cf-cover">
                                                <!-- Large modal -->
                                                <button type="button" class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg">
                                                    <img src="../img/disponible.png" alt="" width="40" height="40">
                                                    <strong style="color: white;"> PERSONAL DISPONIBLE</strong></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="table-responsive">
                                                <table id="myTable2" class="table table-bordered table-hover display nowrap" style="width:100%">
                                                    <thead style="text-align: center;">
                                                        <tr>
                                                            <th class="hola text-center" style="background-color: #82A9D2;">Nomina</th>
                                                            <th class="hola text-center" style="background-color: #78C0A9;">Nombre</th>
                                                            <th class="hola text-center" style="background-color: #97EE7E;">Linea</th>
                                                            <th class="hola text-center" style="background-color: #E98061;">Modificar</th>
                                                        </tr>
                                                    </thead>

                                                    <tbody style="text-align: center;">
                                                        <?php
                                                        $query = "SELECT ST_Empleados.Nomina,ST_Empleados.Nombre,ST_Empleados.Area,ST_Empleados.Encargado,ST_Empleados.NominaEncargado 
                                                        FROM ST_Empleados 
                                                        INNER JOIN empleado ON empleado.id_usuario = ST_Empleados.Nomina
                                                        WHERE ST_Empleados.Estatus = 1 AND empleado.estatus = 1
                                                        and ST_Empleados.Encargado = '$Usuario' OR ST_Empleados.Encargado_2 = '$Usuario'";

                                                        $result = sqlsrv_query($conn, $query);

                                                        while ($row = sqlsrv_fetch_array($result)) {
                                                            echo "<tr>";
                                                            echo "<td style='font-weight: bold;'>" . $row['Nomina'] . "</td>";
                                                            echo "<td>" . $row['Nombre'] . "</td>";
                                                            echo "<td>" . $row['Area'] . "</td>";
                                                            echo "<td> 
                                     <a class='btn btn-secondary' href='../Personal/VerPersonal.php?Nomina=" . $row['Nomina'] . "' ><i class='fa fa-eye-slash'></i> Ver</a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="col-sm-12">
                            ...
                            <h2 class="form-label text-center" style="color: #004D60;"><em>
                                    <img src="../img/add2.png" alt="" width="60" height="55">
                                    <strong>PERSONAL DISPONIBLE </strong> <img src="../img/add2.png" alt="" width="60" height="55">
                                </em></h2>
                            ...
                            <div class="table-responsive">
                                <table id="myTable3" class="table table-bordered table-hover display nowrap">
                                    <thead>
                                        <tr>
                                            <th class="hola text-center" style="background-color: #97EE7E;">Nomina</th>
                                            <th class="hola text-center" style="background-color: #86B0E3;">Nombre</th>
                                            <th class="hola text-center" style="background-color: #F77F73;">Linea</th>
                                            <th class="hola text-center" style="background-color: #9DECBC;">Encargado Anterior</th>
                                            <th class="hola text-center" style="background-color: #A0E7F9;">Agregar</th>
                                        </tr>
                                    </thead>
                                    <tbody style="text-align: center;">
                                        <?php
                                        $query = "SELECT * FROM ST_Empleados 
                                        INNER JOIN empleado ON empleado.id_usuario = ST_Empleados.Nomina 
                                        WHERE ST_Empleados.Estatus = 0 AND empleado.estatus = 1";
                                        ...
                                        while ($row = sqlsrv_fetch_array($result)) {
                                            ...
                                            echo "<td> 
                                <a class='btn btn-info' href='../Personal/CambioLinea.php?Nomina=" . $row['Nomina'] . "' ><i class='fa fa-plus'></i> Add</a>
                                            </td>";
