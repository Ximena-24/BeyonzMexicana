...
<body class="hold-transition sidebar-collapse">
    <div class="estilo py-4">
        ...
        <form class="formulario" action="Nuevos2_0.php" method="post" autocomplete="off" enctype="multipart/form-data">
            <div class="wrapper">
                                                        ...
                                                        <table id="myTable" class="table table-bordered table-striped display nowrap" style="width:100%">
                                                            <thead>
                                                                <tr class="text-center">
                                                                    <th class="sorting text-center" style="background-color: #126896;">Nomina</th>
                                                                    <th class="sorting text-center" style="background-color: #6CADCB;">Nombre Usuario</th>
                                                                    <th class="sorting text-center" style="background-color: #A2A2A2;">Puesto</th>
                                                                    <th class="sorting text-center" style="background-color: #A2A2A2;">Area</th>
                                                                    <th class="sorting text-center" style="background-color: #F5ED71;">Add My People</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody style="text-align: center;">
                                                                <?php
                                                                $query = "SELECT ST_Empleados.Nomina,empleado.usuario,empleado.puesto,empleado.area
                                                                    FROM ST_Empleados
                                                                    INNER JOIN empleado ON empleado.id_usuario = ST_Empleados.Nomina
                                                                    WHERE empleado.estatus = 1 AND ST_Empleados.Nombre IS NULL AND ST_Empleados.Area IS NULL
                                                                ...
                                                                while ($fila = sqlsrv_fetch_array($result)) {
                                                                    echo "<tr>";
                                                                    echo "<td  style='font-weight: bold;'>" . $fila['Nomina'] . "</td>";
                                                                    echo "<td>" . $fila['usuario'] . "</td>";
                                                                    echo "<td>" . $fila['puesto'] . "</td>";
                                                                    echo "<td>" . $fila['area'] . "</td>";
                                                                    echo "<td> 
                              <a class='btn btn-warning' href='../Pantallas/Add2_0.php?Nomina=" . $fila['Nomina'] . "' ><i class='fa fa-user-plus'></i></a>
                                                                      </td>";
                                                                    echo "</tr>";
                                                                }
                                                                ?>
