...
<body class="hold-transition sidebar-collapse">
    <div class="estilo py-4">
        ...
        <form class="formulario" autocomplete="off" action="PreListado.php" method="GET">
            <div class="card-body">
                <div class="abs-center py-2">
                    <form>
                        <div class="row">
                            <div class="col-2">
                            </div>
                            <div class="col-8 text-center">
                                <h1 class="form-label" style="color: #001571;"> <img src="../img/icono.png" alt="" width="75" height="70"><em><strong> Solicitud de Transporte Especial</strong></em></h1>
                            </div>
                            <div class="col-2"></div>
                        </div>
                    </form>
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="formulario" method="POST" action="../registrar4.php">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div id="filtro" class="dataTables_wrapper dt-bootstrap4">
                                                <div class="row">
                                                    <div class="col-sm-8">
                                                        <h3 class="w-100 text-center mb-4" style="font-family: Tahoma ; color:#034842;">Completar Información Transporte Especial</h3>
                                                        ...
                                                        <div class="row zmdi-border-color">
                                                            ...
                                                            <div class="col-md-6 py-2">
                                                                <div class="form-group text-center" required>
                                                                    ...
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                                                    <input type="radio" id="hide" name="Horario" id="Horario" value="11:30pm A 8:00am">
                                                                    <label for="hide">
                                                                        <h6 style="color: #722300;">11:30pm A 8:00am</h6>
                                                                    </label>
                                                                    <div id="content" class="texto text-center"></div>
                                                                    &nbsp;&nbsp;&nbsp;<br>
                                                                    ...
                                                                    <div id="content" class="texto text-center"></div>
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                                                    <input type="radio" id="hide" name="Horario" id="Horario" value="8:30pm A 8:00am">
                                                                    <label for="hide">
                                                                        <h6 style="color: #AB0909;">8:30pm A 8:00am</h6>
                                                                    </label>
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;<br>
                                                                    <input type="radio" id="hide" name="Horario" id="Horario" value="8:00am A 5:36pm">
                                                                    <label for="hide">
                                                                        <h6 style="color: #050373;">8:00am A 5:36pm</h6>
                                                                    </label>
                                                                    <div id="content" class="texto text-center"></div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-3">
                                                                <div class="form-group text-center">
                                                                    ...
                                                                    <select name="tipo_turno" size="2" required="">
                                                            ...
                                                            <div class="col-3">
                                                                <div class="form-group text-center">
                                                                    ...
                                                                    <select name="turno" size="2" required="">
                                                    ...
                                                    <div class="col-sm-4"><!---------------------------->
                                                        <h3 class="w-100 text-center mb-4" style="font-family: Tahoma ; color:#830101;">SELECCION DE PERSONAL</h3>
                                                        <hr style="border:0px; border-top: 1px dotted #028271;">
                                                        <div class="row">
                                                            <div class="col-1"></div>
                                                            <table id="myTable1" class="table table-bordered table-striped display nowrap" style="width:100%">
                                                                <thead style="text-align: center;">
                                                                    <tr>
                                                                        <th style="background-color: #83EA45;">Select</th>
                                                                        <th style="background-color: #87E3C9;">Nomina</th>
                                                                        <th style="background-color: #87AEE3;">Nombre Usuario</th>
                                                                    </tr>
                                                                </thead>
                ...
                <div class="container-fluid">
                    ...
                    and SolicitudTransporte.Responsable = '$Usuario'";
                                            ...
                                            while ($row = sqlsrv_fetch_array($result)) {
                                                ...
                                                echo "<td> 
                    <a class='btn btn-warning' href='../Transporte/Editar/Editar2.php?id_solicitud=" . $row['id_solicitud'] . "&ID=" . $row['ID'] . "' ><i class='fa fa-edit'></i> Editar</a>
                    </td>";
                                                echo "</tr>";
                                            }
                                            ?>
