                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="formulario" method="POST" action="../registrar3.php">
                                    <div class="card-body">
                                        <div class="row">
                                            <!-- ------------------------------------------- -->
                                            <div id="filtro" class="dataTables_wrapper dt-bootstrap4">
                                                <div class="row">
                                                    <div class="col-sm-8">
                                                        <h3 class="w-100 text-center mb-4" style="font-family: Tahoma ; color:#000000;">COMPLETAR INFORMACION TRANSPORTE L-V</h3>
                                                                    ...
                                                                    <div id="content" class="texto text-center">
                                                                        <table class="default text-center">
                                                                            <tr>
                                                                                ...
                                                                                <td class="col-1">
                                                                                    <input name="viernes" value="1" id="1" type="checkbox" />Viernes
                                                                                </td>
                                                                                <td class="col-1">
                                                                                    <input name="sabado" value="1" id="1" type="checkbox" />Sabado
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </div>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped display nowrap" style="width:100%">
                                        <thead style="text-align: center;">
                                            <tr>
                                                ...
                                                <th class="sorting text-center" aria-label="">Sabado</th>
