...
<head>
    ...
    <title>Verificar Transporte</title>
    <!-- Google Web Fonts -->
...
<body class="hold-transition sidebar-collapse">
    ...
    <form class="formulario" action="Verificacion.php" method="post" autocomplete="off" enctype="multipart/form-data">
        <div class="wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="card card-primary card-outline">
                                    <div class="card-body">
                                        <h1 class="text-center" style="color: #001a7b;"><em><strong>
                                                    <img src="../img/7415672.png" alt="#" width="50" height="50" />
                                                    VERIFICACION DE TRANSPORTE</strong></em>
                                            <img src="../img/7415672.png" alt="#" width="50" height="50" />
                                        </h1>
                                                    ...
                                                    <table id="myTable" class="table table-bordered text-center table-sm">
                                                        <thead>
                                                            <tr class="text-center">
                                                                ...
                                                                <th class="sorting text-center">USUARIO</th>
                                                                <th class="sorting text-center" style="background-color: #E8D056;">INICIO</th>
                                                                <th class="sorting text-center" style="background-color: #A7D8D8;">FIN</th>
                                                                ...
                                                                <th class="sorting text-center">TIPO</th>
                                                                <th class="sorting text-center" style="background-color: #9BFF80;">HORA</th>
                                                                <th class="sorting text-center" style="background-color: #DE564A;" aria-label="">FECHA SOLI</th>
                                                                <th class="sorting text-center" style="background-color: #D1D1D1;" aria-label="">RESPONSABLE</th>
                                                                <th class="sorting text-center">VALIDAR</th>
                                                            </tr>
                                                        </thead>

                                                        <tbody style="text-align: center;">
                                                            <?php
                                                            $query = "SELECT SolicitudTransporte.ID,empleado.usuario,SolicitudTransporte.fecha_inicio,SolicitudTransporte.fecha_fin,SM_AltaFinanzas.AF_TelefonoC,
                                                            SM_AltaFinanzas.AF_Domicilio,PersonalTransporte.Id_punto,PuntosAbordaje.Nombre_punto,SR_RUTAS.NOMBRE_RUTA
                                                            ,SolicitudTransporte.tipo_turno,SolicitudTransporte.Hora,SolicitudTransporte.TEspecial,SolicitudTransporte.sabado,
                                                            SolicitudTransporte.turno,SolicitudTransporte.TiempoExSi,SolicitudTransporte.lunes,SolicitudTransporte.martes,SolicitudTransporte.miercoles,
                                                            ...
                                                            FULL JOIN empleado ON empleado.id_usuario = SolicitudTransporte.ID
                                                            WHERE SolicitudTransporte.Estatus = 1 
                                                            ...
                                                            while ($fila = sqlsrv_fetch_array($result)) {
                                                                ...
                                                                echo "<td style='background-color: #E8D056;'>" . $dias_espaniol[date_format($fila['fecha_inicio'], 'w')] . date_format($fila['fecha_inicio'], ' d/m/y') . "</td>";
                                                                ...
                                                                echo "<td>" . $fila['TiempoExSi'] . "</td>";
                                                                echo "<td>" . $fila['lunes'] . "</td>";
                                                                echo "<td>" . $fila['martes'] . "</td>";
                                                                echo "<td>" . $fila['miercoles'] . "</td>";
                                                                echo "<td>" . $fila['jueves'] . "</td>";
                                                                echo "<td>" . $fila['viernes'] . "</td>";
                                                                echo "<td>" . $fila['sabado'] . "</td>";
                                                                if ($fila['TEspecial'] == "1") {
                                                                    echo "<td style='color: #003476; vertical-align: middle;'> <i class='fa fa-times fa-1x' style='color: #b90000;'></i> Normal</td>";
                                                                } else {
                                                                    echo "<td style='color: #003476; vertical-align: middle;'><i class='fa fa-check fa-1x' style='color: #00e41a;'></i> Especial</td>";
                                                                }

                                                                echo "<td style='background-color: #B8FF90;'>" . date_format($fila['Hora'], 'h:i') . "</td>";
                                                                echo "<td style='background-color: #FF938A;'>" . $dias_espaniol[date_format($fila['FechaSolicitud'], 'w')] . date_format($fila['FechaSolicitud'], ' d/m/y') . "</td>";
                                                                echo "<td style='background-color: #D1D1D1; font-weight: bold;'>" . $fila['Responsable'] . "</td>";
                                                                echo "<td> 
                                                                <a class='btn btn-warning' href='../Transporte/Reportes/estatus1.php?ID=" . $fila['ID'] . "' ><i class='fa fa-check'></i> Validar</a>
                                                                 </td>";
                                                                echo "</tr>";
                                                            }
                                                            ?>
