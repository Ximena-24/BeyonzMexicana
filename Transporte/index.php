    ...
    <div class="container">
      ...
      <div class="container py-4">
        <div class="row">
          ...
          <div class="col-12 text-center">
            <h1 class="text-uppercase text-center" style="letter-spacing: 5px; color:#00043D;">Para Solicitar Transporte Selecciona Una Opcion </h1>
          </div>
          <div class="col-2">
          </div>
        </div>
      ...
      <div class="container py-">
        <div class="row">
          ...
          <div class="col-sm-4">
            <img src="../img/especial.gif" alt="" width="65" height="60">
            <a href="PreListado2.php" class="btn btn-success py-md-2 px-md-3 mt-1"><strong>Solicitar Transporte Especial</strong></a>
          </div>
          <div class="col-sm-4">
            <img src="../img/especial.gif" alt="" width="65" height="60">
            <a href="PreListado2.0.php" class="btn btn-danger py-md-2 px-md-3 mt-1"><strong>Transporte Lunes a Viernes</strong></a>
          </div>
